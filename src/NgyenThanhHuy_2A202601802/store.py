...
class EmbeddingStore:
    ...
    def _make_record(self, doc: Document) -> dict[str, Any]:
        ...
        # A document can have multiple chunks, so keep its original id in
        # metadata while assigning every stored record a unique vector id.
    ...
    def add_documents(self, docs: list[Document]) -> None:
        ...
        if self._use_chroma and self._collection is not None:
            try:
                ...
                # A Chroma configuration or metadata limitation must not make
                # the required local classroom workflow unusable.
                self._use_chroma = False
                self._collection = None
                ...
                return [
                    {
                        ...
                        # Chroma reports a distance (smaller is better); turn
                        # it into a descending-friendly score for this API.
                        "score": -distance,
                    }
