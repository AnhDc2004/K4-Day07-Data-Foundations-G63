...
> Khối metadata phía trên là **template mẫu** cho K4. Thay `source_url`, `retrieved_at` và `document_version` bằng nguồn công khai thật trước khi dùng làm benchmark.
